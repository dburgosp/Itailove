{{-- NOTE: GENERATED BY GULP !!! --}}<div class="flo-splash" data-animation="{{ flo_get_option("flo-cube-pages__splash-animation", "fade") }}" style="background-color: {{ flo_get_option("flo-cube-pages__splash-background-color", "#FFFFFF") }};">
