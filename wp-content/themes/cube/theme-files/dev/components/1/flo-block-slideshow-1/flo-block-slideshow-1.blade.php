...
$display_bottom_dot_navigation = flo_data($data, "display_bottom_dot_navigation");
?>
...
<div class="{{$b}} {{$b__uniq}}" data-onready="flo_block_slideshow_1">
  <div
    class="{{$b}}__slides"
    data-slick='{
      ...
      @if ($display_bottom_dot_navigation)
      "dots": true,
      @endif
      "": ""
    }'
      ...
      >
        <div class="{{$b}}__slide-content" style='color: {{$slide["elements_color"]}}'>
          {{-- START: VIDEO BACKGROUND --}}
            ...
            @else
              <div class="{{$b}}__slide-image" style='background-image: url({{$slide["img"]}})'></div>
            @endif
