(function($){
	...
	acf.fields.image = acf.field.extend({
      ...
      'click a[data-name="open_modal"]': 'open_modal'
		},
		...
		*/
		...
		focus: function(){
			...
			this.$input = this.$el.find('.acf-flo-image__input-image-id');
		...
		*/
        ...
        data.url_full = attachment.changed.url;
      ...
      this.$el.find(".acf-flo-image-positioner__image").attr("data-src", data.url_full);
